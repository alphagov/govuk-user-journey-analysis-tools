# govuk-user-journey-analysis-tools documentation build configuration file
#
...
project = "govuk-user-journey-analysis-tools"
...
htmlhelp_basename = "govuk-user-journey-analysis-toolsdoc"
