# Code of conduct for `govuk-user-journey-analysis-tools`
...
- "Project", we mean this `govuk-user-journey-analysis-tools` GitHub repository;
...
[alice.stephenson@digital.cabinet-office.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:alice.stephenson@digital.cabinet-office.gov.uk
